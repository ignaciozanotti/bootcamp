...
module.exports = function(grunt) {
  ...
  compile: {
	options: {
          ...
          modules:[
            {
              name:'scripts/modules/Movie'
            },
			{
              name:'scripts/modules/Director'
            }
          ],
          logLevel: 0,
  ...
  //grunt.registerTask('default', ['jshint', 'concat', 'uglify', 'copy', 'qunit', 'cssmin', 'imagemin']);
